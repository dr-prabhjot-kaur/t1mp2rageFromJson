function [T1map] = EstimateT1fromMP2RAGE(filename, jsonfileinv1,jsonfileinv2, TRFLASH, NzSlices,eff,outputfilename)    
% Example Usage:
...
% 0.0064,[30 120],1.0)
    ...
    MP2RAGE.NZslices= NzSlices; %[ 30 120];% Slices Per Slab * [PartialFourierInSlice-0.5  0.5]
